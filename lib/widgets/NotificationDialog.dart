...
class NotificationDialog extends StatelessWidget {
  ...
  void checkAvailability(context) {
    ...
    showDialog(
        ...
        context: context,
        builder: (BuildContext context) => ProgressDialog(status: 'Подтверждение заказа..',)

    );

    DatabaseReference newRideRef = FirebaseDatabase.instance.reference().child(
    ...
    newRideRef.once().then((DataSnapshot snapshot) {
      ...
      if(snapshot.value != null){
        ...
        Toast.show("Поездка не найдена", context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM);
      }
      ...
      if(thisRideID == tripDetails.rideID){
        ...
        Toast.show("Поездка была отменена", context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM);

      }
      else if(thisRideID == 'timeout'){
        Toast.show("Время запроса на поездку вышло", context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM);
      }
      else{
        Toast.show("Поездка не найдена", context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM);
      }
